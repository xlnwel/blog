...
2. SAC is particularly sensitive to the scaling of the reward signal, because it serves as the temperature of the energy-based optimal policy and thus controls its stochasticity (see Eq.\\((6)\\)).
