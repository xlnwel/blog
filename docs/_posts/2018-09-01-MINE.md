...
$$
\sup_{T:\Omega\rightarrow\mathbb R}\mathbb E_{P(X,Z)}[T]-\log(\mathbb E_{P(X)\otimes P(Z)}[e^T])\tag {2}
$$
...
<figure>
  <img src="../../../../../System/Volumes/Data/Users/aptx4869/github/blog/docs/images/mutual-information/MINE.png" alt="" width="1000">
...
$$
\mathcal R\le D_{KL}(q(\mathbf x, \mathbf z)\Vert p(\mathbf x, \mathbf z))-I_q(\mathbf x, \mathbf z)+H_q(\mathbf x)\tag {3}
$$
...
$$
\forall_{T:\Omega\rightarrow\mathbb R}\mathbb E_P[T]-\log(\mathbb E_Q[e^T])\le D_{KL}(P\Vert Q)\tag {4}
$$
