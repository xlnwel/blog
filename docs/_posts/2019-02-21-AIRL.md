---
title: "GAN-GCL, AIRL"
excerpt: "We build a connection between maximum entropy inverse reinforcement learning and generative adversarial networks, and introduce a practical GAN-style algorithm named adversarial inverse reinforcement learning(AIRL)"
categories:
...
Justin Fu et al. in 2018 proposed an algorithm named Adversarial Inverse Reinforcement Learning (AIRL), which improves GAN-GCL by using single-step transitions instead to reduce variance and employing an additional shaping term to mitigate the effects of unwanted shaping.
